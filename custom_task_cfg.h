 ...
 *----------------------------------------------------------------------------------------------------*/
TASK_ITEM(proc_main_task, main_task_id,   2*1024,  DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_reserved1, reserved1_id,   1*1024,  DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_oled,      OLED_id,        2*1024,  DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_SHT4x,     SHT4x_id,       2*1024,  DEFAULT_VALUE1, DEFAULT_VALUE2) 
TASK_ITEM(proc_ICM42670,  ICM42670_id,    2*1024,  DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_flash,     FLASH_id,       1*1024,  DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_simcard,   SIMCARD_id,     1*1024,  DEFAULT_VALUE1, DEFAULT_VALUE2)
